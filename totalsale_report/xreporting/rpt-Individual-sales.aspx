<%@ Page Title="" Language="C#" MasterPageFile="~/total_sale.master" AutoEventWireup="true" CodeBehind="rpt-Individual-sales.aspx.cs" Inherits="totalsale_report.xreporting.rpt_Individual_sales" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <section class="content-header">
        ...
        <h1>Individual Sales Pages  <%--step 1 check pages content name--%>
                        ...
                        <div class="box-body">
                            ...
                            <div id="divOption">
                                <div class="user-block">
                                    ...
                                    <span class="username">
                                        <a href="#">Individual Sales Setting</a>
