...
{
    public partial class ampelite_reports_sales_co : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    else
                    {
                        ...
                        Response.AddHeader("content-disposition", "attachment; filename=\"AmpelReportSalesCo_" + sdate + ".xlsx\"");
        ...
        protected void btnDownloadExcel_ServerClick(object sender, EventArgs e)
        {
