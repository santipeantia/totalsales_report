<%@ Page Title="" Language="C#" MasterPageFile="~/total_sale.master" AutoEventWireup="true" CodeBehind="marketing-top-range.aspx.cs" Inherits="totalsale_report.xreporting.marketing_top_range" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <section class="content-header">
        ...
        <script>
            ...
            function getResultReportSum(zoneid, zonename, empcodelist, docudate, toprange) {
               // alert(zoneid + zonename + empcode + empname + docudate);
                ...
                $.ajax({
                    url: '../../xreporting/reporting_srv.asmx/GetResultReportMktTopRangeSum',
                    method: 'post',
                    data: {
                        zoneid: zoneid,
                        zonename: zonename,
            ...
            function getResultReport(zoneid, zonename, empcodelist, docudate, toprange) {
               // alert(zoneid + zonename + empcode + empname + docudate);
                ...
                $.ajax({
                    url: '../../xreporting/reporting_srv.asmx/GetResultReportMktTopRange',
                    method: 'post',
                    data: {
                        zoneid: zoneid,
                        zonename: zonename,
            ...
            function loadExcel() {
                var rpt_id = 'resultreportmkttopexcel';
                var zoneid = $('#selectzoneid').val();
                var zonename = $('#selectzoneid option:selected').text();
                var empcodelist = $('#txtRefDoc').val();
                var docudate = $('#datepickerstart').val();
        ...
        <h1>Top Range Report <%--step 1 check pages content name--%>
