<%@ Page Title="" Language="C#" MasterPageFile="~/total_sale.master" AutoEventWireup="true" CodeBehind="epm-sales.aspx.cs" Inherits="totalsale_report.xenterprise.epm_sales" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <section class="content-header">
        ...
        <h1>Sales Pages  <%--step 1 check pages content name--%>
