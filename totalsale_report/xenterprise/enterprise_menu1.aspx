<%@ Page Title="" Language="C#" MasterPageFile="~/total_sale.master" AutoEventWireup="true" CodeBehind="enterprise_menu1.aspx.cs" Inherits="totalsale_report.xenterprise.enterprise_menu1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        ...
        <h1>Enterprise Menu Pages  <%--step 1 check pages content name--%>
