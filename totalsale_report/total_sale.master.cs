...
{
    public partial class total_sale : System.Web.UI.MasterPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    Response.Redirect("signin.aspx?perm=access_denine_pages");
                }
            }
        }
        ...
        protected void GetSystemMenu(string strUsername, string strPassword)
        {
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                for (int i = 0; i <= dt.Rows.Count - 1; i++)
                {
                    ...
                    if (strMenuType == "1")
                    {
                        strMenuEnterprise += "<li><a href =\"../../xenterprise/" + strPageurl + "?opt=epm\"><i class=\"fa fa-angle-right\"></i><span class=\"txtLabel\">" + stMnu_title + "</span></a></li>";
                    }
        ...
        protected void GetSystemActiveMenu(string strOpt) {
            ...
            if (strOpt == "epm") { strActEnterprise = "active"; } else { strActEnterprise = ""; }
