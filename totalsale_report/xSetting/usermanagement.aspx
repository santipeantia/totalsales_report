<%@ Page Title="" Language="C#" MasterPageFile="~/total_sale.master" AutoEventWireup="true" CodeBehind="usermanagement.aspx.cs" Inherits="totalsale_report.xSetting.usermanagement" %>
                        ...
                        <div class="box-body">
                            ...
                            <div id="divOption">
                                <div class="user-block">
                                    <img class="img-circle img-bordered-sm" src="../../dist/img/users.png" alt="User Image">
                                    <span class="username">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="post">
                            ...
                            <p>
                                <button type="button" id="btncheck" name="btncheck">Get multi selected</button></p>
