<%@ Page Title="" Language="C#" MasterPageFile="~/total_sale.master" AutoEventWireup="true" CodeBehind="trn-sales-sharing.aspx.cs" Inherits="totalsale_report.xtransaction.trn_sales_sharing" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        ...
        <h1>Sales Sharing Pages  <%--step 1 check pages content name--%>
                        ...
                        <div class="box-body">
                            ...
                            <div id="divOption">
                                <div class="user-block">
                                    ...
                                    <span class="username">
                                        <a href="#">Sales Sharing Setting</a>
