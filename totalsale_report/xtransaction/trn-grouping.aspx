<%@ Page Title="" Language="C#" MasterPageFile="~/total_sale.master" AutoEventWireup="true" CodeBehind="trn-grouping.aspx.cs" Inherits="totalsale_report.xtransaction.trn_grouping" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        ...
        <h1>Grouping Pages  <%--step 1 check pages content name--%>
